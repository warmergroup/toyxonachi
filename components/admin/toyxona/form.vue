        ...
        <UForm :state="state" class="w-full flex flex-col gap-4">
            <UFormField class="w-full" :label="t('toyxonaForm.nameField')" name="name">
                <UInput class="w-full" variant="soft" v-model="state.name" type="text" size="xl"
                    :placeholder="t('toyxonaForm.nameField')" />
            </UFormField>
            <UFormField class="w-full" :label="t('toyxonaForm.descriptionField')" name="description">
                <UTextarea :placeholder="t('toyxonaForm.descriptionField')" variant="soft" color="neutral"
            ...
            <UFormField class="w-full" :label="t('toyxonaForm.tariffsField')" name="tariff_count">
                <UInput class="w-full" v-model="state.tariff_count" v-maska="'#'" variant="soft" type="text" size="xl"
                    :placeholder="t('toyxonaForm.tariffsField')" />
            </UFormField>
