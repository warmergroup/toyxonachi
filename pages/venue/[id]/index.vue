...
const { data: tariflar, isLoading: tarifLoading } = useGetTariflarQuery(route.params.id as string)
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div class="flex flex-col gap-4 lg:col-span-2">
        ...
        <div class="bg-white flex flex-col gap-3 rounded-xl shadow-lg p-4">
          ...
          <TarifCard v-for="tarif in tariflar" :key="tarif.id" :tarif="tarif"
            @open-drawer="(tarif) => { selectedTarif = tarif; isDrawerOpen = true; }" />
          <UiTarifDrawer :open="isDrawerOpen" :tarif="selectedTarif" @update:open="isDrawerOpen = $event"
