...
import {getToyxonaById} from '~/api/getToyxonaById';
...
<template>
  ...
  <div v-else-if="toyxona" class="lg:p-5 lg:pt-20 w-full h-full">
      ...
      <div class="flex flex-col lg:gap-4 lg:col-span-2 lg:rounded-lg w-full h-full bg-white">
        ...
        <div v-if="!isLargeScreen" ref="imageRef" class="sticky top-0 w-full h-auto">
          <div class="relative">
            ...
            <NuxtImg
              v-else-if="toyxona && toyxona.wedding_hall_pictures.length > 0"
      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="bg-white lg:rounded-lg shadow-sm p-4">
          ...
          <div class="bg-gray-100 rounded-lg overflow-hidden mb-4">
            <YandexMap
              :center="{ lat: toyxona.latitude, lng: toyxona.longitude }" :title="toyxona.name"
              class="w-full h-48"/>
    ...
    <UiSlideOver
      :is-open="openComponent.isOpen && openComponent.componentType === 'showTariff'"
